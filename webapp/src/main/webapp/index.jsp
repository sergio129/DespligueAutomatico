...
<input  type="number" min="0" step="1" formcontrolname="case" id="case" required maxlength="16" matinput placeholder="Expediente" aria-invalid="true" aria-required="true">
